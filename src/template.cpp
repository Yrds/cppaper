...
std::string execTemplate(std::string templateFilePath,
                         const Page &page, const Directory& directory, const Site& site) { // TODO add Site& reference

  inja::Environment env; //TODO maybe make env as a reference, so doesn't need to be included in every iteration with a page
